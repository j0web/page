---
layout: post
title: Markdown, un langage de balisage simple mais efficace
author: Joachim
categories: Langages
tags: markdown
---
...
Bonjour, bienvenue dans ce tutoriel sur le Markdown que vous pouvez forker sur GitHub. 
C'est un langage de balisage simple à utiliser et facile à apprendre. Vous pourrez l'utiliser dans de nombreuses applications.
La version originale est disponible [ici](https://github.com/luong-komorebi/Markdown-Tutorial/blob/master/README.md).
